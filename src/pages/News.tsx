                                ...
                                <div className="max-w-4xl mx-auto">
                                    ...
                                    <div className="grid gap-6">
                                        {NEWS.map((noticia) => (
                                            <article
                                                key={noticia.id}
                                                className="bg-white p-6 rounded-2xl shadow-sm border border-zinc-200 hover:border-indigo-500 transition-colors flex flex-col justify-between"
                                            >
                                                <div>
                                                ...
                                                {/* O Link para o detalhe passa o id na URL */}
