                ...
                <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-xl border border-zinc-300 bg-card">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Ponta Grossa, PR</p>
                        </div>
                    </div>

                    <a href='https://www.instagram.com/ext_pg_unicesumar' target='_blank' rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl border border-zinc-300 bg-card">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">ext_pg_unicesumar</p>
                        </div>
                    </a>
                </div>
        </main >
